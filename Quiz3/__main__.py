...
# მეილი იგზავნება ჩემი ბითიუს მეილიდან რასაც ვერ შეცვლით, 
# თუ გინდათ თქვენი მეილიდან გაიგზავნოს email_sender.py-ში 
# უნდა წახვიდეთ და api-ს token უნდა შეცვალოთ
...
def __main__():
    ...
    for index, language in enumerate(languages):
        ...
        # თუ გატესტვა გინდათ სწრაფად დაწიეთ 10-15 
        # წამამდე ან თუ გინდათ სულ მოხსენით
        time.sleep(60)
